...
insert into Menu values(N'Quần áo','Helmets')
insert into Menu values(N'Áo khoác','RiddingGear')
insert into Menu values(N'Phụ kiện','Accsesories')
insert into Menu values(N'Nhãn hiệu ','Brand')
insert into Menu values(N'Tin tức','Blog')
insert into Menu values(N'Liên hệ','Contact')

insert into  ItemType values(N'Áo nam','2')
insert into  ItemType values(N'Áo nữ','2')
insert into  ItemType values(N'Áo sơ mi','2')
insert into  ItemType values(N'Quần jean','2')
insert into  ItemType values(N'Áo khoác nam','3')
insert into  ItemType values(N'Áo khoác nữ','3')
insert into  ItemType values(N'Dây nịch','4')


insert into  Brand values(N'Supreme','5')
insert into  Brand values(N'Convert','5')

insert into  Item(Name,PurcharsePrice,SellPrice,DateImport,Quantity,TypeID,BrandID,Picture,[Active],[ShortTitle],[Describe]) values(N'Áo Sơ Mi Nam Lịch Lãm',6,7,'2019/4/5',40,3,1,'ao1.jpg',1,N'Chất liệu lụa trơn cao cấp thấm hút mồ hôi',N'Áo Sơ Mi Nam Lịch Lãm với kiểu dáng áo tay dài, cổ bẻ thời thượng cho phái mạnh phong cách thời trang mạnh mẽ, nam tính và lịch lãm.
...
Gam màu hiện đại dễ dàng phối với nhiều trang phục, mang đến vẻ ngoại hiện đại và lịch lãm cho các chàng trai sành điệu với thiết kế ôm nhẹ cơ thể, giúp tôn lên đường nét săn chắc, gọn gàng và đầy cuốn hút.')
 ...
 insert into  Item(Name,PurcharsePrice,SellPrice,DateImport,Quantity,TypeID,BrandID,Picture,[Active],[ShortTitle],[Describe]) values(N'Áo thun nữ mon amor',6,9,'2019/4/5',40,2,2,'ao2.jpg',1,N'Chất liệu lụa trơn cao cấp thấm hút mồ hôi',N'Áo Sơ Mi Nam Lịch Lãm với kiểu dáng áo tay dài, cổ bẻ thời thượng cho phái mạnh phong cách thời trang mạnh mẽ, nam tính và lịch lãm.
Đặc biệt, áo được may từ chất liệu vải lụa trơn cao cấp, thấm hút mồ hôi tốt mang lại cảm giác thoải mái, tự tin và dễ chịu.
Gam màu hiện đại dễ dàng phối với nhiều trang phục, mang đến vẻ ngoại hiện đại và lịch lãm cho các chàng trai sành điệu với thiết kế ôm nhẹ cơ thể, giúp tôn lên đường nét săn chắc, gọn gàng và đầy cuốn hút.')

 insert into  Item(Name,PurcharsePrice,SellPrice,DateImport,Quantity,TypeID,BrandID,Picture,[Active],[ShortTitle],[Describe]) values(N'Áo Sơ Mi Nam',4,10,'2019/4/5',40,1,2,'ao3.jpg',1,N'Chất liệu lụa trơn cao cấp thấm hút mồ hôi',N'Áo Sơ Mi Nam Lịch Lãm với kiểu dáng áo tay dài, cổ bẻ thời thượng cho phái mạnh phong cách thời trang mạnh mẽ, nam tính và lịch lãm.
Đặc biệt, áo được may từ chất liệu vải lụa trơn cao cấp, thấm hút mồ hôi tốt mang lại cảm giác thoải mái, tự tin và dễ chịu.
Gam màu hiện đại dễ dàng phối với nhiều trang phục, mang đến vẻ ngoại hiện đại và lịch lãm cho các chàng trai sành điệu với thiết kế ôm nhẹ cơ thể, giúp tôn lên đường nét săn chắc, gọn gàng và đầy cuốn hút.')

insert into  Item(Name,PurcharsePrice,SellPrice,DateImport,Quantity,TypeID,BrandID,Picture,[Active],[ShortTitle],[Describe]) values(N'Dây Nịch Nylon',5,16,'2019/4/5',40,7,1,'ao4.jpg',1,N'Chất liệu lụa trơn cao cấp thấm hút mồ hôi',N'Áo Sơ Mi Nam Lịch Lãm với kiểu dáng áo tay dài, cổ bẻ thời thượng cho phái mạnh phong cách thời trang mạnh mẽ, nam tính và lịch lãm.
Đặc biệt, áo được may từ chất liệu vải lụa trơn cao cấp, thấm hút mồ hôi tốt mang lại cảm giác thoải mái, tự tin và dễ chịu.
Gam màu hiện đại dễ dàng phối với nhiều trang phục, mang đến vẻ ngoại hiện đại và lịch lãm cho các chàng trai sành điệu với thiết kế ôm nhẹ cơ thể, giúp tôn lên đường nét săn chắc, gọn gàng và đầy cuốn hút.')

insert into  Item(Name,PurcharsePrice,SellPrice,DateImport,Quantity,TypeID,BrandID,Picture,[Active],[ShortTitle],[Describe]) values(N'Quần Jean Nam',5,16,'2019/4/5',40,4,2,'ao5.jpg',1,N'Chất liệu lụa trơn cao cấp thấm hút mồ hôi',N'Áo Sơ Mi Nam Lịch Lãm với kiểu dáng áo tay dài, cổ bẻ thời thượng cho phái mạnh phong cách thời trang mạnh mẽ, nam tính và lịch lãm.
Đặc biệt, áo được may từ chất liệu vải lụa trơn cao cấp, thấm hút mồ hôi tốt mang lại cảm giác thoải mái, tự tin và dễ chịu.
Gam màu hiện đại dễ dàng phối với nhiều trang phục, mang đến vẻ ngoại hiện đại và lịch lãm cho các chàng trai sành điệu với thiết kế ôm nhẹ cơ thể, giúp tôn lên đường nét săn chắc, gọn gàng và đầy cuốn hút.')

insert into  Item(Name,PurcharsePrice,SellPrice,DateImport,Quantity,TypeID,BrandID,Picture,[Active],[ShortTitle],[Describe]) values(N'Áo Khoác Nữ',5,16,'2019/4/5',40,4,2,'ao6.jpg',1,N'Chất liệu lụa trơn cao cấp thấm hút mồ hôi',N'Áo Sơ Mi Nam Lịch Lãm với kiểu dáng áo tay dài, cổ bẻ thời thượng cho phái mạnh phong cách thời trang mạnh mẽ, nam tính và lịch lãm.
Đặc biệt, áo được may từ chất liệu vải lụa trơn cao cấp, thấm hút mồ hôi tốt mang lại cảm giác thoải mái, tự tin và dễ chịu.
Gam màu hiện đại dễ dàng phối với nhiều trang phục, mang đến vẻ ngoại hiện đại và lịch lãm cho các chàng trai sành điệu với thiết kế ôm nhẹ cơ thể, giúp tôn lên đường nét săn chắc, gọn gàng và đầy cuốn hút.')

insert into [Admin] values('Admin','1',N'Nguyen Van Admin','hinh.png')

insert into Banner values('bannerao1.png')
insert into Banner values('bannerao2.jpg')
